...
// Verify the create New is visible
  ...
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('textbox', { name: 'Filter By Keyword' }).fill(credentials.programProjectTimeSensitiveType);
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('heading', { name: credentials.programProjectTimeSensitiveType }).first().click();
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('textbox', { name: 'Project Name' }).fill(credentials.projectTitleTimeSensitive);
  ...
  //Time Sensitive
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().locator('//span[contains(text(),"Project time sensitive")]').click();
  ...
  const futureToday = (today.getDate() + 1);
  const datePlus3 = new Date(today);
  datePlus3.setDate(today.getDate() + 3);
  const dayPlus3 = datePlus3.getDate();

// Select Date
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('cell', { name: futureToday.toString(), exact: true }).first().click();
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('cell', { name: dayPlus3.toString() }).first().click();


// Time Select

   await page.locator('iframe[name="RTM20_IN1"]').contentFrame().locator('(//i[@class= "icon icon-project-type-time-sensitive icon-color-primary"])[1]').click();
   await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByText('08:30 AM').first().click();
   await page.locator('iframe[name="RTM20_IN1"]').contentFrame().locator('(//i[@class= "icon icon-project-type-time-sensitive icon-color-primary"])[2]').click();
   await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByText('09:00 AM').nth(1).click();


//Specific Date
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().locator('//span[contains(text(),"Specific Date")]').click();
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('cell', { name: futureToday.toString(), exact: true }).click();
