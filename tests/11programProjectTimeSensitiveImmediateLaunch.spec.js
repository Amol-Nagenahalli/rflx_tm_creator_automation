...
// Verify the create New is visible
  ...
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('textbox', { name: 'Project Name' }).fill(credentials.projectTitleTimeSensitiveImmediateLaunch);
  ...
  const dayToday = (today.getDate() + 1);
...
// Select Date
  ...
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().getByRole('cell', { name: dayPlus3.toString() }).nth(1).click();
...
//Immediate
  await page.locator('iframe[name="RTM20_IN1"]').contentFrame().locator('//span[contains(text(), "Immediate")]').click();
